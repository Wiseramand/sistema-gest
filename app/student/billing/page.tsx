    ...
    return (
        <div className="billing-page container">
            ...
            <style jsx>{`
                ...
                .due-card { padding: 2.5rem; background: linear-gradient(135deg, #0a2a5e 0%, #1a4fa0 100%); color: white; border: none; border-radius: 24px; position: relative; overflow: hidden; margin-bottom: 2rem; }
                ...
                .bank-info { padding: 2.5rem; border-left: 6px solid #F5C518; }
                .bank-info h3 { margin-top: 0; color: #0a2a5e; font-size: 1.25rem; font-weight: 800; margin-bottom: 2rem; }
                ...
                .bank-instructions { margin-top: 2rem; padding: 1.25rem; background: #fffbeb; border-radius: 12px; border: 1px solid #fef3c7; color: #92400e; font-size: 0.85rem; line-height: 1.5; }
                ...
                .upload-hdr h3 { margin: 0; color: #0a2a5e; font-weight: 800; }
                .upload-card p { font-size: 0.85rem; color: #64748b; line-height: 1.5; margin-bottom: 1.5rem; }
                
                .upload-btn { background: #0a2a5e; color: white; border: none; padding: 1rem; border-radius: 12px; font-weight: 800; display: block; width: 100%; cursor: pointer; transition: 0.2s; }
                .upload-btn:hover { background: #3b82f6; transform: translateY(-2px); }
                ...
                .support-card strong { color: #0a2a5e; }
            `}</style>
        </div>
    );
}
