    ...
    return (
        <div className="chat-container">
            <div className="chat-header">
                <h1>Apoio ao Aluno</h1>
                <p>Retira as tuas dúvidas com a Administração</p>
            </div>
            ...
            <div className="chat-messages" ref={scrollRef}>
                ...
                {!loading && messages.length === 0 && (
                    <div className="empty-chat">
                        ...
                        <p>Olá! Precisas de ajuda? Envia uma mensagem à administração.</p>
                    </div>
                )}
            </div>
            ...
            <style jsx>{`
                ...
                .chat-header { padding: 1.5rem 2rem; background: #0f172a; color: white; }
