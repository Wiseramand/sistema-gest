  ...
  return (
    <div className="page-wrap">
      <div className="page-header">
        ...
        <p>Validação de transferências e controlo detalhado de caixa.</p>
      </div>
      ...
      <div className="page-content card">
        <div className="empty-state">
          ...
          <p>O módulo de pagamentos está a ser preparado. Aqui poderá conciliar os pagamentos com as matrículas através de integração com referências ou envios de comprovativos.</p>
        </div>
      </div>
