  ...
  return (
    <div className="page-wrap">
      ...
      <style jsx>{`
        ...
        .btn-primary { background: #E6C5A8; color: #2D180F; border: none; padding: 0.6rem 1.2rem; border-radius: 8px; font-weight: 700; font-family: 'DM Sans', sans-serif; cursor: pointer; transition: 0.2s; }
        .btn-primary:hover { background: #9A3412; color: white; }
        ...
        .action-btn.email-mini { background: #FDF2E9; color: #2D180F; border: none; padding: 0.4rem 0.8rem; border-radius: 6px; font-weight: 700; cursor: pointer; }
        .action-btn.email-mini:hover { background: #FDF2E9; }
      `}</style>
    </div>
  );
}
