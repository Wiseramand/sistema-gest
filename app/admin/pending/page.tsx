  ...
  return (
    <div className="page-wrap">
      <div className="page-header">
        <h1>Pendentes & Inadimplentes</h1>
        <p>Controlo rigoroso de inscrições aguardando pagamento ou documentação essencial.</p>
      </div>
      
      <div className="page-content card">
        <div className="empty-state">
          <span className="icon">⏳</span>
          <h2>Regularização de Inscrições</h2>
          <p>Módulo de gestão de alertas financeiros. Visualize rapidamente quais formandos necessitam concluir pagamentos antes da atribuição de certificados.</p>
        </div>
      </div>
