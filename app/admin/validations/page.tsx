...
const CertificateModal = ({ doc, onClose }: { doc: any, onClose: () => void }) => (
  <div className="modal-overlay" onClick={onClose}>
    ...
    <style jsx>{`
      ...
      .cert-border { border: 15px double #0a2a5e; padding: 3rem; text-align: center; color: #0a2a5e; }
      
      .mtc-logo { font-size: 3rem; margin-bottom: 1rem; color: #F5C518; }
      ...
      .cert-body h3 { font-family: 'Outfit', sans-serif; font-size: 1.4rem; color: #F5C518; text-decoration: underline; margin-bottom: 1.5rem; }
      .cert-intro { font-size: 0.9rem; font-style: italic; color: #475569; }
      .student-name { font-size: 2.2rem; font-weight: 900; margin: 1.5rem 0; font-family: 'Outfit', sans-serif; border-bottom: 2px solid #F5C518; display: inline-block; padding: 0 2rem; }
      ...
      .seal { font-size: 0.8rem; font-weight: 800; border: 2px solid #F5C518; color: #F5C518; padding: 0.5rem; border-radius: 50%; width: 80px; height: 80px; display: flex; align-items: center; justify-content: center; transform: rotate(-15deg); }
      .signature { text-align: center; }
      .sig-line { width: 150px; border-top: 2px solid #0a2a5e; margin-bottom: 0.5rem; }
